...
var i_29768 = (0);
while(true){
if((i_29768 < arr.length)){
(arr[i_29768] = null);

var G__29770 = (i_29768 + (1));
i_29768 = G__29770;
continue;
} else {
}
...
var i_29820 = (self__.level + (1));
while(true){
if((i_29820 <= (new_level + (1)))){
(update[i_29820] = self__.header);

var G__29824 = (i_29820 + (1));
i_29820 = G__29824;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_29831 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_29831[i]));
} else {
x__$2.forward.push((((i < links_29831.length))?(links_29831[i]):null));
}

if((i < links_29831.length)){
(links_29831[i] = x__$2);
} else {
links_29831.push(x__$2);
}
...
var i_29843 = (0);
while(true){
if((i_29843 <= self__.level)){
var links_29844 = (update[i_29843]).forward;
if((x__$1 === (((i_29843 < links_29844.length))?(links_29844[i_29843]):null))){
(links_29844[i_29843] = (x__$1.forward[i_29843]));

var G__29846 = (i_29843 + (1));
i_29843 = G__29846;
continue;
} else {
var G__29847 = (i_29843 + (1));
i_29843 = G__29847;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__29897 = nx;
var G__29898 = (level__$1 - (1));
x = G__29897;
level__$1 = G__29898;
continue;
} else {
var G__29901 = x;
var G__29902 = (level__$1 - (1));
x = G__29901;
level__$1 = G__29902;
continue;
}
