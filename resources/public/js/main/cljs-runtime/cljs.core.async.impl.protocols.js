...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_27287 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_27287(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_27292 = (function (port,val,fn1_handler){
var x__5373__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_27292(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_27295 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_27295(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_27296 = (function (chan){
var x__5373__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_27296(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_27301 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_27301(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_27303 = (function (h){
var x__5373__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_27303(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_27308 = (function (h){
var x__5373__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_27308(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_27318 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_27318(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_27329 = (function (b){
var x__5373__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_27329(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_27334 = (function (b,itm){
var x__5373__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_27334(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_27344 = (function (b){
var x__5373__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_27344(b);
}
});
