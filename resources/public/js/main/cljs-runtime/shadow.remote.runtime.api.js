...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_29331 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_29331(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_29339 = (function (runtime,key,spec){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_29339(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_29352 = (function (runtime,key){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_29352(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_29377 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_29377(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_29396 = (function (runtime,input,callback){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_29396(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_29419 = (function (runtime,code,success,fail){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_29419(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__29320,callback){
var map__29321 = p__29320;
var map__29321__$1 = cljs.core.__destructure_map(map__29321);
var input = map__29321__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29321__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29321__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
